            ...
            <div class="header"> <!--Header MEnu Bar-->
                ...
                <div id="search">
                        <div id="SBar">Search </div>
                            <span id="ext"><form id="SForm" method="GET" action="">
                                <img src="im/search.png"><input id="FSub" type="submit" value="Search">&nbsp;<input id="Ftxt" type="text" name="s_value">
                                </form></span>
            ...
            <div class="col1"><!--SLideShow-- THE BODY MIDDLE SECTION--> 
                <?php
                    ...
                    echo "<div id ='sdes' style='color:grey;font-size:1.5em;width:59%;height: 6rem;position: absolute;top:30rem;z-index:2;opacity:0.9;padding:0% 0.5% 0% 0.5%'>".$first[0][1]."</div>";
                            ...
                            echo '<span><img id="b0" src="im/button1.png" width="20px" height="20px"></span>';
                            for ($a=1;$a<$size;$a++)
                            { 
                                echo '<span><img id="b'.$a.'"src="im/button2.png" width="20px" height="20px"></span>';
                            }
                            echo "</div>";
                ?>
            </div>
